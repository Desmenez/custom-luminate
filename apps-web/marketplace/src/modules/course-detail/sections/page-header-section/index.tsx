...
export function PageHeaderDesktop(props: PageHeaderSectionProps) {
  return (
    <div className="container max-lg:hidden">
      <div className="relative h-[403px] xl:h-[546px] py-4 xl:py-[68px] px-[50px] xl:px-[108px]">
        ...
        <div className="xl:w-[590px] flex flex-col items-start gap-3 xl:gap-4">
          ...
          <button className="flex flex-row items-center gap-4" onClick={props.onClickStars}>
            {props.ratingStars.toFixed(1)}
            <RatingStars rating={props.ratingStars} />
          </button>
          <Features className="w-fit xl:gap-2 flex-wrap max-h-[91px]" features={props.features} />
        </div>
      </div>
    </div>
  )
        ...
        <CourseDetailSection>
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm flex flex-row items-center gap-4">
              {props.ratingStars.toFixed(1)} <RatingStars rating={props.ratingStars} size={16} />
            </div>
