...
import { QueryKeyArgs } from './query-key'
import {
  DataResponse,
...
export type AppRouteFunctions<TAppRoute extends AppRoute, TClientArgs extends ClientArgs> = {
...
export type DataReturnFetchQueryHook<
  ...
  TArgs = PartialClientInferRequest<TAppRoute, TClientArgs>,
> = AreAllPropertiesOptional<TArgs> extends true
  ? (args?: TArgs, options?: FetchQueryOptions<TAppRoute>) => Promise<DataResponse<TAppRoute>>
  : (args: TArgs, options?: FetchQueryOptions<TAppRoute>) => Promise<DataResponse<TAppRoute>>
...
> = AreAllPropertiesOptional<TArgs> extends true
  ...
  : (queryClient: QueryClient, args: TArgs, options?: FetchQueryOptions<TAppRoute>) => Promise<void>
...
export type DataReturnPrefetchQueryHook<
  ...
  TArgs = PartialClientInferRequest<TAppRoute, TClientArgs>,
> = AreAllPropertiesOptional<TArgs> extends true
  ? (args?: TArgs, options?: FetchQueryOptions<TAppRoute>) => Promise<void>
  : (args: TArgs, options?: FetchQueryOptions<TAppRoute>) => Promise<void>
...
export type DataReturnGetQueryData<TAppRoute extends AppRoute> = (
  queryClient: QueryClient,
  queryKeyArgs: QueryKeyArgs<TAppRoute, ClientArgs>,
